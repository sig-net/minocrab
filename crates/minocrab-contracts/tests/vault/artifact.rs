...
impl Circuit {
    ...
    pub fn build(self) -> Compiled3 {
        match self {
            Circuit::Initialise => erc20_vault::initialise(),
            Circuit::ApproveStata => erc20_vault::approve_stata(),
            Circuit::ApproveRouter => erc20_vault::approve_router(),
            Circuit::StartDeposit => erc20_vault::start_deposit(),
            Circuit::CompleteDeposit => erc20_vault::complete_deposit(),
            Circuit::StartWithdraw => erc20_vault::start_withdraw(),
            Circuit::CompleteWithdraw => erc20_vault::complete_withdraw(),
            Circuit::RefundWithdraw => erc20_vault::refund_withdraw(),
            Circuit::StartSwap => erc20_vault::start_swap(),
            Circuit::CompleteSwap => erc20_vault::complete_swap(),
            Circuit::RefundSwap => erc20_vault::refund_swap(),
            Circuit::StartSupply => erc20_vault::start_supply(),
            Circuit::CompleteSupply => erc20_vault::complete_supply(),
            Circuit::RefundSupply => erc20_vault::refund_supply(),
            Circuit::StartRedeem => erc20_vault::start_redeem(),
            Circuit::CompleteRedeem => erc20_vault::complete_redeem(),
            Circuit::RefundRedeem => erc20_vault::refund_redeem(),
        }
    }
