...
property!(initialize_matches_spec, pending::initialize().ir, gen::initialize(), spec::spec_initialize, |s| &s.env);
property!(approve_router_matches_spec, pending::approve_router().ir, gen::approve_router(), spec::spec_approve_router, |s| &s.env);
property!(approve_stata_matches_spec, pending::approve_stata().ir, gen::approve_stata(), spec::spec_approve_stata, |s| &s.env);
property!(deposit_matches_spec, pending::deposit().ir, gen::start_deposit(), spec::spec_start_deposit, |s| &s.env);
property!(claim_matches_spec, pending::claim().ir, gen::claim(), spec::spec_claim, |s| &s.d.env);
property!(claim_auto_receive_matches_spec, pending::claim().ir, gen::claim_auto_receive(), spec::spec_claim, |s| &s.d.env);
property!(withdraw_matches_spec, pending::withdraw().ir, gen::start_withdraw(), spec::spec_start_withdraw, |s| &s.env);
property!(complete_withdraw_matches_spec, pending::complete_withdraw().ir, gen::complete_withdraw(), spec::spec_complete_withdraw, |s| &s.w.env);
property!(refund_withdrawal_matches_spec, pending::refund_withdrawal().ir, gen::refund_withdrawal(), spec::spec_refund_withdrawal, |s| &s.w.env);
property!(swap_matches_spec, pending::swap().ir, gen::start_swap(), spec::spec_start_swap, |s| &s.env);
property!(complete_swap_matches_spec, pending::complete_swap().ir, gen::complete_swap(), spec::spec_complete_swap, |s| &s.s.env);
property!(refund_swap_matches_spec, pending::refund_swap().ir, gen::refund_swap(), spec::spec_refund_swap, |s| &s.s.env);
property!(supply_matches_spec, pending::supply().ir, gen::start_supply(), spec::spec_start_supply, |s| &s.env);
property!(complete_supply_matches_spec, pending::complete_supply().ir, gen::complete_supply(), spec::spec_complete_supply, |s| &s.s.env);
property!(refund_supply_matches_spec, pending::refund_supply().ir, gen::refund_supply(), spec::spec_refund_supply, |s| &s.s.env);
property!(redeem_matches_spec, pending::redeem().ir, gen::start_redeem(), spec::spec_start_redeem, |s| &s.env);
property!(complete_redeem_matches_spec, pending::complete_redeem().ir, gen::complete_redeem(), spec::spec_complete_redeem, |s| &s.s.env);
property!(refund_redeem_matches_spec, pending::refund_redeem().ir, gen::refund_redeem(), spec::spec_refund_redeem, |s| &s.s.env);
