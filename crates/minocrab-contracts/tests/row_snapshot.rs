...
const SNAPSHOT: &[(&str, u8, usize)] = &[
    ...
    ("erc20_vault_opt::claim", 16, 42067),
    ("erc20_vault_opt::approve_router", 14, 13332),
    ("erc20_vault_opt::withdraw", 15, 23707),
    ("erc20_vault_opt::complete_withdraw", 16, 40174),
    ("erc20_vault_opt::refund", 16, 40822),
    ("erc20_vault_opt::swap", 16, 32819),
    ("erc20_vault_opt::complete_swap", 16, 50286),
    ("erc20_vault_borsh::initialize", 13, 2412),
    ("erc20_vault_borsh::deposit", 14, 15614),
    ("erc20_vault_borsh::claim", 16, 42075),
    ("erc20_vault_borsh::approve_router", 14, 13314),
    ("erc20_vault_borsh::withdraw", 15, 23689),
    ("erc20_vault_borsh::complete_withdraw", 16, 40182),
    ("erc20_vault_borsh::refund", 16, 40814),
    ("erc20_vault_borsh::swap", 15, 28625),
    ("erc20_vault_borsh::complete_swap", 16, 50297),
    ("erc20_vault_modern::initialize", 13, 2412),
    ("erc20_vault_modern::deposit", 14, 15614),
    ("erc20_vault_modern::claim", 16, 42075),
    ("erc20_vault_modern::approve_router", 14, 13314),
    ("erc20_vault_modern::withdraw", 15, 23689),
    ("erc20_vault_modern::complete_withdraw", 16, 40182),
    ("erc20_vault_modern::refund", 16, 40814),
    ("erc20_vault_modern::swap", 15, 28625),
    ("erc20_vault_modern::complete_swap", 16, 50297),
    ("erc20_vault_pending::initialize", 13, 2446),
    ("erc20_vault_pending::deposit", 14, 15666),
    ("erc20_vault_pending::claim", 16, 41813),
    ("erc20_vault_pending::approve_router", 14, 13341),
    ("erc20_vault_pending::withdraw", 15, 23732),
    ("erc20_vault_pending::complete_withdraw", 16, 39888),
    ("erc20_vault_pending::refund_withdrawal", 16, 39881),
    ("erc20_vault_pending::swap", 15, 28678),
    ("erc20_vault_pending::complete_swap", 16, 49418),
    ("erc20_vault_pending::refund_swap", 16, 39912),
