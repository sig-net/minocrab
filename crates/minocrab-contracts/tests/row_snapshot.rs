...
const SNAPSHOT: &[(&str, u8, usize)] = &[
    ...
    ("erc20_vault::deposit", 13, 5321),
    ("erc20_vault::claim", 16, 43326),
    ("erc20_vault::approve_router", 11, 1162),
    ("erc20_vault::withdraw", 15, 30188),
    ("erc20_vault::complete_withdraw", 16, 43132),
    ("erc20_vault::refund", 16, 60896),
    ("erc20_vault::swap", 15, 31008),
    ("erc20_vault::complete_swap", 16, 60736),
    ("erc20_vault_opt::initialize", 13, 2412),
    ("erc20_vault_opt::deposit", 13, 3449),
    ("erc20_vault_opt::claim", 16, 37733),
    ("erc20_vault_opt::approve_router", 11, 1150),
    ("erc20_vault_opt::withdraw", 14, 11526),
    ("erc20_vault_opt::complete_withdraw", 16, 35840),
    ("erc20_vault_opt::refund", 16, 36487),
    ("erc20_vault_opt::swap", 14, 12350),
    ("erc20_vault_opt::complete_swap", 16, 45951),
    ("erc20_vault_borsh::initialize", 13, 2412),
    ("erc20_vault_borsh::deposit", 13, 3424),
    ("erc20_vault_borsh::claim", 16, 37740),
    ("erc20_vault_borsh::approve_router", 11, 1126),
    ("erc20_vault_borsh::withdraw", 14, 11502),
    ("erc20_vault_borsh::complete_withdraw", 16, 35847),
    ("erc20_vault_borsh::refund", 16, 36480),
    ("erc20_vault_borsh::swap", 14, 12326),
    ("erc20_vault_borsh::complete_swap", 16, 45961),
    ("erc20_vault_modern::initialize", 13, 2412),
    ("erc20_vault_modern::deposit", 13, 3424),
    ("erc20_vault_modern::claim", 16, 37740),
    ("erc20_vault_modern::approve_router", 11, 1126),
    ("erc20_vault_modern::withdraw", 14, 11502),
    ("erc20_vault_modern::complete_withdraw", 16, 35847),
    ("erc20_vault_modern::refund", 16, 36480),
    ("erc20_vault_modern::swap", 14, 12326),
    ("erc20_vault_modern::complete_swap", 16, 45961),
