...
const SNAPSHOT: &[(&str, u8, usize)] = &[
    ...
    ("erc20_vault_pending::initialize", 10, 891),
    ...
    ("erc20_vault_pending::complete_withdraw", 15, 25655),
    ("erc20_vault_pending::refund_withdrawal", 16, 35605),
    ("erc20_vault_pending::swap", 14, 12379),
    ("erc20_vault_pending::complete_swap", 16, 45082),
    ("erc20_vault_pending::refund_swap", 16, 35651),
    ("erc20_vault_pending::approve_stata", 11, 1120),
    ("erc20_vault_pending::supply", 14, 11474),
    ("erc20_vault_pending::complete_supply", 16, 35576),
    ("erc20_vault_pending::refund_supply", 16, 35630),
    ("erc20_vault_pending::redeem", 14, 11631),
    ("erc20_vault_pending::complete_redeem", 16, 35581),
    ("erc20_vault_pending::refund_redeem", 16, 35635),
